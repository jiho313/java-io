...
public class MallService {
	 ...
	 *  예외 : RuntimeException, 사용자 정보가 없거나 비밀번호가 일치하지 않는 경우
	 */
	...
	public void order(int productNo, int quantity, String userId) {
		...
		//		주문번호, 주문날짜, 사용자아이디, 상품정보, 총 구매금액, 적립포인트를 대입한다.
	...
	public List<Map<String, Object>> getMyOrders(String userId){
		...
		List<Order> orders = orderRepo.getOrderByUserId(userId);
